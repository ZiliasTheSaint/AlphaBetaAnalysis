...
public class AboutFrame extends JFrame{
	 ...
	 */
	public AboutFrame(AlphaBetaAnalysis mf) {
		...
		jLabel1.setForeground(AlphaBetaAnalysis.foreColor);
		jLabel2.setForeground(AlphaBetaAnalysis.foreColor);
		lbAuthor.setForeground(AlphaBetaAnalysis.foreColor);
		lbVersion.setForeground(AlphaBetaAnalysis.foreColor);
		jLabel7.setForeground(AlphaBetaAnalysis.foreColor);
		textLicense.setBackground(AlphaBetaAnalysis.textAreaBkgColor);
		textLicense.setForeground(AlphaBetaAnalysis.textAreaForeColor);
	...
	private void createGUI() {
		...
		jPanel1.setBackground(AlphaBetaAnalysis.bkgColor);
		...
		jPanel3.setBackground(AlphaBetaAnalysis.bkgColor);
		...
		jPanel2.setBackground(AlphaBetaAnalysis.bkgColor);
